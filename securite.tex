La sécurité est aspect important de ce projet, en raison de l'utilisation d'un robot UR$3$ dans un espace confiné pour manipuler des composants chimiques. Cette section détaille les mesures mises en oeuvre ou à mettre en oeuvre pour assurer la sécurité des opérateurs, du matériel et des échantillons.
...
\begin{landscape}
    \begin{table}[ht]
        ...
        2                      & \gls{microcapsule}apsule non saisie                   & Erreur lors des analyses                                                                                                            & 1                                                           & 2                                                             & 2                                                              \\
        3                      & \gls{microcapsule}apsule non déposée                  & \begin{tabular}[c]{@{}l@{}}Erreur lors des analyses\\ Détéroration des prochaines \glspl{microcapsule}\end{tabular}                         & 3                                                           & 2                                                             & 6                                                              \\
        4                      & Perte de \gls{microcapsule} lors du déplacement & \begin{tabular}[c]{@{}l@{}}Erreur lors des analyses\\ Contamination de la \gls{glovebox}\end{tabular}                                    & 4                                                           & 3                                                             & 12                                                             \\
        5                      & Renversement d'une wellplate              & \begin{tabular}[c]{@{}l@{}}Perte de la totalité des capsules de la wellplate\\ Contamination de la \gls{glovebox}\end{tabular}           & 5                                                           & 2                                                             & 10                                                             \\
        6                      & Renversement d'une \gls{paradox}          & \begin{tabular}[c]{@{}l@{}}Perte de la totalité des capsules présentes dans la \gls{paradox}\\ Contamination de la \gls{glovebox}\end{tabular} & 5                                                           & 3                                                             & 15                                                             \\
...
\begin{table}[H]
    \begin{tabular}{l|c|c}
        ...
        $5$          & \begin{tabular}[c]{@{}l@{}}Ajout de trous sur la \textit{wellplate} \\pour améliorer la prise de la pince.\end{tabular}                                        & Occurence\\
