...
\begin{figure}[H]
    ...
    \end{subfigure}
\end{figure}
\footnotetext[1]{\href{https://onrobot.com/fr/produits/prehenseur-gecko-0}{https://onrobot.com/fr/produits/prehenseur-gecko-0}}
\footnotetext[2]{\href{https://www.cobots.ch/fr/produit/robotiq-main-adaptative-a-3-doigts/}{https://www.cobots.ch/fr/produit/robotiq-main-adaptative-a-3-doigts/}}
...
\begin{table}[H]
    ...
    Pince à doigt & \begin{tabular}[c]{@{}l@{}}- Contrôle précis\\ - Faible coût\end{tabular}                                                        & \begin{tabular}[c]{@{}l@{}}- Maintenance fréquente\\ - Ne convient pas aux petits objets\\ - Espace limité, pour pouvoir ouvrir \\ et fermer la pince \\ - Nécessite un contrôle de force\end{tabular} \\
